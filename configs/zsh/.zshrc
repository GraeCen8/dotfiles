...
echo -e "${NEWLINE}\x1b[38;5;217m\x1b[48;5;0m it's$(print -P '%D{%_I:%M%P}\n') \x1b[38;5;117m\x1b[48;5;0m $(uptime -p | cut -c 4-) \x1b[38;5;183m\x1b[48;5;0m $(uname -r) \033[0m" # current (Rosé Pine: rose / foam / iris)
